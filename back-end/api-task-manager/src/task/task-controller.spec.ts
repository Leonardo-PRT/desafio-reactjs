...
describe('TaskController', () => {
  ...
  describe('createTask', () => {
    ...
    it('should throw BadRequestException for invalid input', async () => {
      ...
      await expect(controller.create(createTaskDto, userId)).rejects.toThrow(
        BadRequestException,
      );
    });
  });
  ...
  describe('getTaskById', () => {
    ...
    it('should throw NotFoundException when task not found', async () => {
      ...
      await expect(controller.detail(taskId)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('updateTask', () => {
    ...
    it('should throw BadRequestException for invalid input', async () => {
      ...
      await expect(
        controller.update(taskId, updateTaskDto, userId),
  ...
  describe('deleteTask', () => {
    ...
    it('should throw NotFoundException when task not found', async () => {
      ...
      await expect(controller.delete(taskId, userId)).rejects.toThrow(
        NotFoundException,
      );
    });
  });
