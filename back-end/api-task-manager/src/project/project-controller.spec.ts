...
describe('ProjectController', () => {
  ...
  describe('addMember', () => {
    it('should add a member to a project', async () => {
      ...
      await controller.addMember(addMemberDto, 1);
  ...
  describe('removeMember', () => {
    it('should remove a member from a project', async () => {
      ...
      jest
        ...
        .mockResolvedValue({ message: 'Member removed successfully' });
  ...
  describe('findAll', () => {
    it('should return all projects with pagination', async () => {
      ...
      const size = 10;
      const projects = [
        { id: 1, name: 'Project 1', description: 'descricao', ownerId: 1 },
        { id: 2, name: 'Project 2', description: 'test', ownerId: 1 },
      ];
      const total = 2;

      jest
        .spyOn(service, 'findAll')
        .mockResolvedValue({ data: projects, total, page, size });
    ...
    it('should throw BadRequestException if page or size parameters are invalid', async () => {
      ...
      await expect(
        controller.findAll(invalidPage, invalidSize),
  ...
  describe('error handling', () => {
    ...
    describe('addMember', () => {
      it('should throw NotFoundException if project not found', async () => {
        ...
        await expect(controller.addMember(addMemberDto, 1)).rejects.toThrow(
          NotFoundException,
        );
        expect(service.addMember).toHaveBeenCalledWith(addMemberDto, 1);
      });
    ...
    describe('removeMember', () => {
      it('should throw NotFoundException if project not found', async () => {
        ...
        await expect(
          controller.removeMember(projectId, memberId, 1),
    ...
    describe('update', () => {
      it('should throw NotFoundException if project not found', async () => {
        ...
        await expect(
          controller.update(projectId, updateProjectDto),
        ).rejects.toThrow(NotFoundException);
  ...
  describe('detail', () => {
    it('should return a project by ID', async () => {
      const project = {
        ...
        description: 'Test Description',
        ownerId: 1,
        tasksCount: 0, // Add this
        _count: { tasks: 0 }, // Add this
      };
    ...
    it('should throw InternalServerErrorException if detail retrieval fails', async () => {
      ...
      await expect(controller.detail(1)).rejects.toThrow(
        InternalServerErrorException,
      );
      expect(service.detail).toHaveBeenCalledWith(1);
    });
